...
import { CustomersTable } from '@/components/dashboard-01/customers-table';
import { DashboardCharts } from '@/components/dashboard-01/dashboard-charts';
import { DashboardHeader } from '@/components/dashboard-01/dashboard-header';
import { DashboardSidebar } from '@/components/dashboard-01/dashboard-sidebar';
      ...
      <SidebarInset className="min-w-0" id="overview" ref={bindTheme}>
        ...
        <div className="@container/metrics border-b">
          <dl className="grid @3xl/metrics:grid-cols-4 grid-cols-2">
            {metrics.map((metric) => (
              <div
                className="flex min-w-0 flex-col justify-center gap-2 border-b @3xl/metrics:border-b-0 @3xl/metrics:not-first:border-l @3xl/metrics:px-7 px-4 py-6 even:border-l nth-last-[-n+2]:border-b-0"
                key={metric.label}
              >
