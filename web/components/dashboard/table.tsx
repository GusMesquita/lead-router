...
import { ArrowUp, ArrowDown, CaretUpDown, DotsThree, User, Pencil, Trash, Shield, MagnifyingGlass, Columns, Plus, Download, UserGear, CaretLeft, CaretRight } from "@phosphor-icons/react"
...
function SortIcon({ sorted }: { sorted: false | "asc" | "desc" }) {
  ...
  return (
    <CaretUpDown className="size-3.5 text-muted-foreground/60" aria-hidden="true" />
  )
}
  ...
  },
  {
    ...
    header: ({ column }) => (
      <button
        ...
        className="-mx-1 inline-flex items-center gap-1 rounded-md px-1 text-xs font-semibold tracking-widest text-muted-foreground uppercase transition-colors hover:text-foreground"
      >
        Member
  ...
  },
  {
    ...
    header: ({ column }) => (
      <button
        type="button"
        onClick={() => column.toggleSorting(column.getIsSorted() === "asc")}
        className="-mx-1 ml-auto inline-flex items-center gap-1 rounded-md px-1 text-xs font-semibold tracking-widest text-muted-foreground uppercase transition-colors hover:text-foreground"
      >
        Joined
        <SortIcon sorted={column.getIsSorted()} />
      </button>
    ...
    <section className="w-full">
      <div className="w-full rounded-xl border border-border bg-card">
        ...
        {selectedCount > 0 && (
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border bg-muted/40 px-6 py-2.5">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              >
                <UserGear className="size-3.5" aria-hidden="true" />
                Change role
              </Button>
              <Button
                variant="outline"
        ...
        <div>
          ...
          <div className="flex items-center justify-between gap-4 rounded-b-xl border-t border-border bg-muted/20 px-6 py-3">
